...
{
    public class ContactDetailVM(string name, string email, string phone, string cellPhone, string fieldOrIndustry, string position, string address, string status, List<Note> notes)
    {
        ...
        public List<Note> Notes { get; private set; } = notes;
    }
}
